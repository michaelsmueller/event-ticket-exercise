...
contract EventTickets {
    ...
    */
    event LogBuyTickets(address indexed buyer, uint indexed tickets);
    ...
    */
    constructor(string memory description, string memory url, uint ticketNumber) public {
        owner = msg.sender;
        myEvent.description = description;
        myEvent.website = url;
        myEvent.totalTickets = ticketNumber;
        myEvent.isOpen = true;
    }
    ...
    */
        ...
        payable
    {
        ...
        uint amountToRefund = msg.value - tickets * TICKET_PRICE;
